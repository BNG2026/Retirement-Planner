...
# Retirement planning app created as a June project variant.
# Uses Streamlit to project retirement account balances, income sources, and withdrawals over time.
...
st.markdown(
    ...
    "3. Run `streamlit run retirement_planner_june.py`.\n"
